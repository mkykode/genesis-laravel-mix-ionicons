...
$local695_onboarding_config = [
	'dependencies'     => [
		'plugins' => [
			[
				'name'       => __( 'Atomic Blocks', 'local695' ),
				'slug'       => 'atomic-blocks/atomicblocks.php',
				'public_url' => 'https://atomicblocks.com/',
			],
			[
				'name'       => __( 'Simple Social Icons', 'local695' ),
				'slug'       => 'simple-social-icons/simple-social-icons.php',
				'public_url' => 'https://wordpress.org/plugins/simple-social-icons/',
			],
			[
				'name'       => __( 'Genesis eNews Extended (Third Party)', 'local695' ),
				'slug'       => 'genesis-enews-extended/plugin.php',
				'public_url' => 'https://wordpress.org/plugins/genesis-enews-extended/',
			],
			[
				'name'       => __( 'WPForms Lite (Third Party)', 'local695' ),
...
if ( get_option( 'fresh_site' ) ) {
	foreach ( $local695_starter_packs as $local695_starter_pack => $local695_starter_pack_content ) {
		$local695_onboarding_config['starter_pack'][ $local695_starter_pack ]['sample-post-1'] = [
			'post_title'     => $local695_starter_pack_content['post_title'][0],
			'post_content'   => require dirname( __FILE__ ) . '/import/content/post-example.php',
			'post_type'      => 'post',
			'post_status'    => 'publish',
			'featured_image' => CHILD_URL . "/config/import/images/{$local695_starter_pack}/{$local695_starter_pack}-sample-1.jpg",
			'comment_status' => 'closed',
			'ping_status'    => 'closed',
		];
		$local695_onboarding_config['starter_pack'][ $local695_starter_pack ]['sample-post-2'] = [
			'post_title'     => $local695_starter_pack_content['post_title'][1],
			'post_content'   => require dirname( __FILE__ ) . '/import/content/post-example.php',
			'post_type'      => 'post',
			'post_status'    => 'publish',
			'featured_image' => CHILD_URL . "/config/import/images/{$local695_starter_pack}/{$local695_starter_pack}-sample-2.jpg",
			'comment_status' => 'closed',
			'ping_status'    => 'closed',
		];
		$local695_onboarding_config['starter_pack'][ $local695_starter_pack ]['sample-post-3'] = [
			'post_title'     => $local695_starter_pack_content['post_title'][2],
			'post_content'   => require dirname( __FILE__ ) . '/import/content/post-example.php',
			'post_type'      => 'post',
			'post_status'    => 'publish',
			'featured_image' => CHILD_URL . "/config/import/images/{$local695_starter_pack}/{$local695_starter_pack}-sample-3.jpg",
			'comment_status' => 'closed',
			'ping_status'    => 'closed',
		];
		$local695_onboarding_config['starter_pack'][ $local695_starter_pack ]['sample-post-4'] = [
			'post_title'     => $local695_starter_pack_content['post_title'][3],
			'post_content'   => require dirname( __FILE__ ) . '/import/content/post-example.php',
			'post_type'      => 'post',
			'post_status'    => 'publish',
			'featured_image' => CHILD_URL . "/config/import/images/{$local695_starter_pack}/{$local695_starter_pack}-sample-4.jpg",
			'comment_status' => 'closed',
			'ping_status'    => 'closed',
		];
	}
	...
	foreach ( $local695_starter_packs as $local695_starter_pack => $local695_starter_pack_content ) {
		$local695_onboarding_config['starter_pack'][ $local695_starter_pack ] = [];
	}
}

return $local695_onboarding_config;
