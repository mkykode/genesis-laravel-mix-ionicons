...
add_action( 'wp_enqueue_scripts', 'local695_custom_gutenberg_css' );
/**
 ...
 * @since 1.1.0
 */
function local695_custom_gutenberg_css() {
...
CSS;
	...
	$css .= local695_inline_font_sizes();
	$css .= local695_inline_color_palette();

	wp_add_inline_style( genesis_get_theme_handle() . '-gutenberg', $css );

}

add_action( 'enqueue_block_editor_assets', 'local695_custom_gutenberg_admin_css' );
/**
 ...
 * @since 1.1.0
 */
function local695_custom_gutenberg_admin_css() {
 ...
 */
function local695_inline_font_sizes() {
 ...
 */
function local695_inline_color_palette() {
